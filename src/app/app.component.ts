      ...
      if(this.AuthService.ActiveUser !== null) {
        ...
        if(this.Pool.Mitarbeiterdaten.Favoritenliste.length === 0) {
          ...
          if(environment.production) {
            ...
            Page = this.Const.Pages.PjFestlegungslistePage; // PjSchnellaufgabenListePage; // PjSimontabellelistePage; // PjListePage; // PjSimontabellelistePage; // PjProtokolleListePage; // PjProtokolleListePage; // PjAufgabenlistePage; // UrlaubFreigabenPage; // UrlaubPlanungPage; // PjBaustelleLoplistePage; //
